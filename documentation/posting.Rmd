...
# 요약 
  ...
  * PUBG-M의 출시는 다른 게임의 매출에 지속적인 충격을 주지 못한 것으로 보인다. 
...
여가는 돈과 더불어 시간을 소모한 활동이다. 돈은 개인별로 제약에 큰 차이가 있지만 시간은 대체로 차이가 적다. 아울러 시간의 제약은 돈에 제약에 비해 탄력적이지 못하다. 아무리 게임을 좋아해도 하루에 24시간 이상을 투입할 수는 없다.  모바일 이용자가 PUBG-M를 하느라 다른 게임을 하지 않았다면, 기존 게임의 점유율이 줄어들고 이에 따라서 매출도 줄어들게 될 것이다. 물론 이런 현상이 관찰되기 위해서는 몇가지 사전 조건이 성립해야 한다. 
